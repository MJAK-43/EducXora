...
use App\Http\Controllers\LearnerPedagogyController;
...
Route::middleware(['auth', 'auth.session', 'active', 'fresh.session'])->group(function (): void {
    ...
    Route::middleware('verified')->group(function (): void {
        ...
        Route::middleware(['tenant', 'tenant.member', 'organization.active'])->group(function (): void {
            ...
            Route::get('/learners/{learnerUuid}/pedagogy', [LearnerPedagogyController::class, 'show'])->name('learners.pedagogy');
            Route::patch('/learners/{learnerUuid}/level', [LearnerPedagogyController::class, 'updateLevel'])->name('learners.level.update');
            ...
            Route::get('/pedagogy/questions', [PlacementQuestionController::class, 'index'])->name('pedagogy.questions.index');
            Route::get('/pedagogy/questions/create', [PlacementQuestionController::class, 'create'])->name('pedagogy.questions.create');
            Route::post('/pedagogy/questions', [PlacementQuestionController::class, 'store'])->name('pedagogy.questions.store');
            Route::get('/pedagogy/questions/{questionUuid}/edit', [PlacementQuestionController::class, 'edit'])->name('pedagogy.questions.edit');
            Route::patch('/pedagogy/questions/{questionUuid}', [PlacementQuestionController::class, 'update'])->name('pedagogy.questions.update');
            Route::patch('/pedagogy/questions/{questionUuid}/disable', [PlacementQuestionController::class, 'disable'])->name('pedagogy.questions.disable');
            Route::patch('/pedagogy/questions/{questionUuid}/enable', [PlacementQuestionController::class, 'enable'])->name('pedagogy.questions.enable');
            Route::post('/pedagogy/learners/{learnerUuid}/tests', [PlacementTestController::class, 'start'])->name('pedagogy.tests.start');
            Route::get('/pedagogy/tests/{attemptUuid}', [PlacementTestController::class, 'show'])->name('pedagogy.tests.show');
            Route::post('/pedagogy/tests/{attemptUuid}/answers', [PlacementTestController::class, 'answer'])->name('pedagogy.tests.answers.store');
